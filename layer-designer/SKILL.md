...
| Quality | Resolution | Minimum Timeout |
|---------|-----------|-----------------|
| `low` | ≤ 1024×1024 | **150 seconds** |
| `medium` | ≤ 1024×1024 | 150–250 seconds |
| `high` | ≤ 1024×1024 | 250–350 seconds |
| `low` | 2K (e.g. 1792×1024) | 250–300 seconds |
| `medium` | 2K | 300–400 seconds |
| `high` | 2K+ (e.g. 2048×2048, 4K) | **450+ seconds** |
